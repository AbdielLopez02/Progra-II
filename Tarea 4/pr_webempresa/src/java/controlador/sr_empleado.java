        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if("crear".equals(request.getParameter("btn_crear"))){
                ...
                if(empleado.crear()>0){
                    ...
                    response.sendRedirect("solohtml.jsp?status=success&action=crear");
                }else{
                    out.println("<h1>No se agrego</h1>");
                    response.sendRedirect("solohtml.jsp?status=error&action=crear");
            ...
            if("actualizar".equals(request.getParameter("btn_actualizar"))){
                ...
                if(empleado.actualizar()>0){
                    ...
                    response.sendRedirect("solohtml.jsp?status=success&action=actualizar");
                }else{
                    out.println("<h1>No se actualizo</h1>");
                    response.sendRedirect("solohtml.jsp?status=error&action=actualizar");
            ...
            if("eliminar".equals(request.getParameter("btn_eliminar"))){
                ...
                if(empleado.eliminar()>0){
                    ...
                    response.sendRedirect("solohtml.jsp?status=success&action=eliminar");
                }else{
                    out.println("<h1>No se elimino</h1>");
                    response.sendRedirect("solohtml.jsp?status=error&action=eliminar");
